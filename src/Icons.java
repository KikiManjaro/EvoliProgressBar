...
public interface Icons {
    Icon ICON = IconLoader.getIcon("/0.gif");
    Icon ICON2 = IconLoader.getIcon("/2.gif");
    Icon ICON4 = IconLoader.getIcon("/4.gif");
    Icon ICON6 = IconLoader.getIcon("/6.gif");
    ...
    Icon RICON5 = IconLoader.getIcon("/5.gif");
    Icon RICON7 = IconLoader.getIcon("/7.gif");
